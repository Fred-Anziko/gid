...
"""Create expert table"""
try:
    gidexpert_sql="CREATE TABLE experts(Personnel_Expert_Id_No INTEGER NOT NULL FOREIGN KEY(Personnel_Id_No) REFERENCES personnel ON DELETE RESTRICT,Expert_Purpose_And_Desires,Expert_Qualifications VARCHAR(250),Expert_Skills VARCHAR(250),Expert_Interests_And_Hobbies(250),Expert_Referee_Name VARCHAR(25),Expert_Referee_Contact VARCHAR(25),Expert_Facial_Reco BLOB)"
